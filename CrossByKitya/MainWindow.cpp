...
LRESULT CALLBACK MainWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        HFONT CreateFont(
            ...
            int nWidth,                // средн€€ ширина символа
...
void RepaintMe(HWND hWnd) {
    PAINTSTRUCT ps; //экземпл€р структуры рисовани€
